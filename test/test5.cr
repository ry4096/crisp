...
# quote, code, and code-unsafe represent unevaluated syntax trees.
# quote is like code, but does not carry a return type.
# Often an expected type must be supplied when
# calling a quote, using the : interpreter function.
# Quotes should not be used like this because they are slow.
# Use function instead.

# These tests using quote, code, and code-unsafe were created
# before function existed.
