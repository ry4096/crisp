...
# code is a chunk of unevaluated code with a return type.
# The code tree is type checked every time it is called.
# For better performance, use code-unsafe or function.
